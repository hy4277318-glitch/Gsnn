...
BOT_TOKEN = os.getenv("7782412259:AAH9D952JvU_i4ma3goBceMZSoxelSCWvwA")
MONGODB_URI = os.getenv("mongodb+srv://himanshuyadavyadav167_db_user:3QZk2sQZNbTxsH5K@cluster0.0r5pdj3.mongodb.net/?appName=Cluster0")
...
ADMIN_IDS = [int(id.strip()) for id in os.getenv("ADMIN_IDS", "6676943475").split(",")]
